...
class Group:
    ...
    def get_stats(self, df):
        ...
        author_buffer_details = {'Days_texted': self.get_number_activeDays(df), 'Start_date': Start_date,
                                 'Last_date': Last_date, 'Letter_count': Letter_count,
                                 'Word_count': Word_count, 'Media_shared': self.get_number_mediasShared(df),
